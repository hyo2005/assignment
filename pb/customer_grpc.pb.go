...
func (c *customerServiceClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*Customer, error) {
	out := new(Customer)
...
func (c *customerServiceClient) FindCustomer(ctx context.Context, in *FindCustomerRequest, opts ...grpc.CallOption) (*Customer, error) {
	out := new(Customer)
...
func (c *customerServiceClient) BookingHistory(ctx context.Context, in *BookingHistoryRequest, opts ...grpc.CallOption) (*BookingHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/assignment.CustomerService/BookingHistory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCustomerServiceServer) ChangePassword(context.Context, *ChangePasswordRequest) (*Customer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangePassword not implemented")
}
func (UnimplementedCustomerServiceServer) FindCustomer(context.Context, *FindCustomerRequest) (*Customer, error) {
...
func _CustomerService_FindCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).FindCustomer(ctx, req.(*FindCustomerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CustomerService_BookingHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/assignment.CustomerService/BookingHistory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
